...
# \blfootnote{ $\,^2$ European Institute fo Theoretical Neuroscience, 74 Rue du Faubourg Saint-Antoine, 75012 Paris}
\blfootnote{correspondance : <lastname>@unic.cnrs-gif.fr}

#+LaTeX_HEADER: \def\shorttitle{Heterogenous firing response leads to diverse coupling to synaptic activity}
#+LaTeX_HEADER: \def\shortauthor{yann} 
...
# #+LaTeX_HEADER:\usepackage{amssymb,mathenv,array,breqn}
...
# #+LaTeX_HEADER: \usepackage{natbib,hyperref}
