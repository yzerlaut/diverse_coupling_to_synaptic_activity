...
creating a post-synaptic event $\mathrm{PSP}_{syn}(t)$.

In addition, we added a synchrony factor $F_\mathrm{synch}$ that
accounts for the effects of the synchronous arrivals of presynaptic
events. Given the synchrony generator considered in the main text, the
synchrony factor takes the form:
...
\section{Deriving the fluctuations properties}
\label{sec-5}
