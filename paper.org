...
Here specific form of presynaptic stimulation
 that are well defined in a framework
...
Very naturally, the key quantity to explain the various neuronal
...
strongly correlated with cellular excitability.


In our companion communication, we related the sensitivity to the
speed of the fluctuations


with the notable exception of proximal activity.
...
In our companion communication, we introduced four measures
characterizing the cellular properties in the fluctuation-driven
regime, the present analysis shed some light on their physiological
relevance. 
...
authors explained those observations by an increased local recurrent
connectivity and argued that this diverse coupling did not seem to be
explained by biophysical heterogeneity (e.g. the coupling was
independent from the action potential threshold, somehow a measure of
the excitability). However, as local connectivity is thought to target
more proximal regions [[cite:Spruston2008]], our study proposes a
biophysical mechanism that could contribute to this phenomena. The
...
our description of proximal activity is somehow adequate, i.e. the
activity remains balanced and elicits strong changes in the speed of
the fluctuations while limiting variations of \sigma_V and 2) that the
biophysical heterogeneity observed in young mice cortex is at least
partially preserved in adult animals. 

Future work could adress this hypothesis by combining recordings of
population activity with a more subtle and functionnally-relevant
analysis of single cell biophysics
...
,
i.e. putatively linked to the impact of sodium inactivation and the
density of sodium channels [[cite:Zerlaut2016]]. 


A more subtle characterization of the
cellular biophysical properties could indeeed
...
3s, the simulationwas repeated over 4 seeds to yield a mean and a
