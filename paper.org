...
* Abstract
  ...
  single neuron contribute to such differential activation.
...
by introducing an analytically tractable dendritic model, we presented
the final form of our theoretical framework for single cell
computation in the fluctuation-driven regime.
...
[[stress why population dynamics and dendritic integration are linked]]
