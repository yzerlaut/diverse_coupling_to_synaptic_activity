...
the standard deviation \sigma_V of the fluctuation. 


Nonetheless, the trend in the variations of the fluctuations as a
function of the model variables is kept between the analytical
estimate and the numerical simulations. This relatively good agreement
therefore shows that our analytical estimate is a valid tool to study
dendritic integration in the fluctuation-driven regime.
