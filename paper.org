...
* Abstract
  ...
  activities: either unbalanced, synchronized, purely proximal or
  purely distal. We found that, because of their various firing
  responses, individual neurons differentially couple to each type of
  presynaptic activity. The main contribution to this heterogenous
  coupling were the different levels of cellular excitability (action
  potential threshold). 

  The present study therefore introduce a new functional impact of
  biophysical heterogeneity: specific coupling to particular types of
  synaptic activity.
...
exponent rule [[cite:Rall1962]], the analytical consists in adapting the
equivalent cylinder transformation [[cite:Rall1962]] to the properties of
the high conductance state [[cite:Destexhe2003]].
